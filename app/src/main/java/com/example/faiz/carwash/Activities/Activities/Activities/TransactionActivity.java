...
import com.example.faiz.carwash.Activities.Activities.UI.Transaction_Summary;
...
//                                Toast.makeText(context, "CONNECTED", Toast.LENGTH_SHORT).show();
                                        Snackbar snackbar = Snackbar
                                                .make(transaction_container, "Internet Connected", Snackbar.LENGTH_LONG);

                                        snackbar.getView().setBackgroundColor(ContextCompat.getColor(TransactionActivity.this, R.color.colorWhite));
...
// Changing action button text color
                                ...
                                if (!doubleFlag) {
                                    Snackbar snackbar = Snackbar
                                            .make(transaction_container, "No internet connection!", Snackbar.LENGTH_INDEFINITE);
                                    ;
                                    snackbar.getView().setBackgroundColor(ContextCompat.getColor(TransactionActivity.this, R.color.colorWhite));
...
//                            .add(R.id.transaction_container, new Add_Customer()).commit();
                    Intent intent = new Intent(TransactionActivity.this, CustomerActivity.class);
