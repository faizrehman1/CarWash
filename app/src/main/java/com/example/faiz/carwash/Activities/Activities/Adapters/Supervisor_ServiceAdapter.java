...
public class Supervisor_ServiceAdapter extends ArrayAdapter<Owner_Services> {

    public ArrayList<Owner_Services> blockArrayList;
    public Context context;

    public Supervisor_ServiceAdapter(@NonNull Context context, ArrayList<Owner_Services> blockArrayList) {
        super(context, 0);
    ...
    private View createItemView(int position, View convertView, ViewGroup parent) {
        ...
        text1.setText(blockArrayList.get(position).getService_title());
